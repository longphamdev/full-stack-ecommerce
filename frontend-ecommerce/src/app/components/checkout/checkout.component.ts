...
export class CheckoutComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, private longphamdevShopFormService: LongphamdevShopFormService, private cartService: CartService, private checkoutService: CheckoutService, private router: Router) { }
